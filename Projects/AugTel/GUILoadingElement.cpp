	...
	:IGUIElement(ElementType,mngr)
{
	...
	m_layer1.SetTexture(gTextureResourceManager.loadTexture2D("Loading1.png"));
	m_layer2.SetTexture(gTextureResourceManager.loadTexture2D("Loading2.png"));
	m_layer3.SetTexture(gTextureResourceManager.loadTexture2D("Loading3.png"));
}
