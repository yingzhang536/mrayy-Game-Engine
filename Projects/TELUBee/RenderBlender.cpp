...
{
	core::string bs=TBAppGlobals::GetValue(tabName,"BlendingSpeed");
	core::string staticB=TBAppGlobals::GetValue(tabName,"StaticBlending");
	core::string BlendFactorA=TBAppGlobals::GetValue(tabName,"BlendFactorA");
	core::string BlendFactorB=TBAppGlobals::GetValue(tabName,"BlendFactorB");
	if(bs=="")
		SetSpeed(0.3);
	else
	...
	TBAppGlobals::SetValue(tabName,"StaticBlending",core::StringConverter::toString(e));
	TBAppGlobals::SetValue(tabName,"BlendFactorA",core::StringConverter::toString(a));
	TBAppGlobals::SetValue(tabName,"BlendFactorB",core::StringConverter::toString(b));
}
