...
using namespace GUI;
class GUIScreenLayout_V1:public GUI::IGUISchemeBase
{
...
public:
	...
	GUIScreenLayout_V1():Root(0),SessionsBar(0),SessionDetails(0),TweetDetails(0),TEDxTokyo_Logo(0),RootStack(0),UserTxt(0),UsersList(0),UserProfile(0),TweetsList(0)
	{		
