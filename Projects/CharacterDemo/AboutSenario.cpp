...
AboutSenario::AboutSenario(){
...

	{
		...
		core::string creditsPath=CharacterDemoGlobals::getInstance()->getAssestsPath()+mT("Credits/");
		fos->changeDir(path +creditsPath);
...

	{
		...
		item= new CAboutText(mT("Virtual Character Simulation"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(235,235,235,255));
		addItem(item);
		item= new CAboutText(mT("Physics-Based Locomotion Control,"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(235,235,235,255));
		addItem(item);
		item= new CAboutText(mT("Movement Planning"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(235,235,235,255));
		addItem(item);
		item= new CAboutText(mT("And"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(235,235,235,255));
		addItem(item);
		item= new CAboutText(mT("Behavior Simulation."),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(235,235,235,255));
		addItem(item);

		item= new CAboutText(mT("Syrian University"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,100,100,255));
		addItem(item);

		item= new CAboutText(mT("5Th Year - AI"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,100,100,255));
		addItem(item);

		item= new CAboutText(mT("Graduation Project"),this,math::vector2d(400,30),0);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,100,100,255));
		addItem(item);

		item= new CAboutText(mT("Supervisors"),this,math::vector2d(400,40),1);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,0,0,255));
		item->setSpace(20);
		addItem(item);

		item= new CAboutText(mT("Professor Ammar Joukhadar"),this,math::vector2d(400,40),0);
		addItem(item);

		item= new CAboutText(mT("Engineer Ehab Hraki"),this,math::vector2d(400,40),0);
		addItem(item);

		item= new CAboutText(mT("Students"),this,math::vector2d(400,40),1);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,0,0,255));
		item->setSpace(20);
		addItem(item);
		item= new CAboutText(mT("Khaldoon Ganem"),this,math::vector2d(400,40),0);
		addItem(item);
		item= new CAboutText(mT("Muhammad Yamen Saraiji"),this,math::vector2d(400,40),0);
		addItem(item);
		item= new CAboutText(mT("Ubai Sandouk"),this,math::vector2d(400,40),0);
		addItem(item);

		item= new CAboutText(mT("2009-2010"),this,math::vector2d(400,40),1);
		item->getElem()->getFontAttributes()->fontColor=(video::SColor(255,0,0,255));
		item->setSpace(20);
		addItem(item);
...
void AboutSenario::update(float dt){
	...
	case 1:
		if(m_bgAlpha<255){
			...
			if(m_bgAlpha>255)
				m_bgAlpha=255;
			m_fadeOutImg->Color=video::SColor(m_fadeOutImg->Color().R,m_fadeOutImg->Color().G,m_fadeOutImg->Color().B,m_bgAlpha);
		}else
			m_currentState=2;
		break;
	case 2:
