...
public:
	...
	virtual void DoneLoadingElements()
	{
		...
		FacultyList->SetDockLeft(SessionsBar);

//		CommentsPanel->SetDockTop(SessionDetails);
//		CommentsPanel->SetDockLeft(SessionsBar);
//		CommentsPanel->SetDockBottom(FacultyList);


		LayersRoot->SetDockLeft(SessionsBar);
		LayersRoot->SetDockTop(SessionDetails);
		LayersRoot->SetDockBottom(FacultyList);
//		ScenePanel->SetLeftElement(SessionsBar);
//		ScenePanel->SetTopElement(SessionDetails);
		//ScenePanel->SetBottomElement(CommentDetails);
	}
};
