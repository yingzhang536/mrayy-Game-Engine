...
_3dsLoader_old::RenderMaterialInfo::RenderMaterialInfo()
{
	mat=new video::RenderMaterial();
	mat->CreateTechnique(mT("Default"))->CreatePass(mT("Default"));
}
scene::SMesh* _3dsLoader_old::load(const  core::string&filename)
{
...
scene::SMesh*_3dsLoader_old::load(OS::IStream* stream)
{
...
bool _3dsLoader_old::canLoad(const  core::string&name)
{
...
void _3dsLoader_old::ReadChunk(tChunk *pChunk)
{
...
void _3dsLoader_old::ReadPercentageChunk(float &out, tChunk *pChunk)
{
...
void _3dsLoader_old::ProcessNextChunk(scene::SMesh*pModel, tChunk *pPreviousChunk)
{
...
void _3dsLoader_old::ProcessNextObjectChunk(scene::SMesh*pModel, scene::IMeshBuffer *pObject, tChunk *pPreviousChunk)
{
...
void _3dsLoader_old::ProcessNextMaterialChunk(scene::SMesh*pModel, tChunk *pPreviousChunk)
{
	int buffer[10000] = {0};					// This is used to read past unwanted data
	char strBuffer[256];
	// Allocate a new chunk to work with
...
int _3dsLoader_old::GetString(core::string &out)
{
	int index = 0;
	char pBuffer[1024];
...
void _3dsLoader_old::ReadColorChunk(video::SColor *clr, tChunk *pChunk)
{
		...
		case _3DS_COL_LIN_24:
			{
				...
				clr->Set(ucolor[0] * math::i255, ucolor[1] * math::i255, ucolor[2] * math::i255, 1);
				pChunk->bytesRead += m_TempChunk->bytesRead;
			}
			break;
		case _3DS_COL_RGB:
		case _3DS_COL_LIN_F:
			{
				...
				clr->Set((float)(fcolor[0]),(float)(fcolor[1]),(float)(fcolor[2]),1);
		 		pChunk->bytesRead += m_TempChunk->bytesRead;
			}
			break;
		default:
...
void _3dsLoader_old::ReadVertexIndices(scene::IMeshBuffer *pObject, tChunk *pPreviousChunk)
{
...
void _3dsLoader_old::ReadUVCoordinates(scene::IMeshBuffer *pObject, tChunk *pPreviousChunk)
{
	int nov=0;
...
void _3dsLoader_old::ReadVertices(scene::IMeshBuffer *pObject, tChunk *pPreviousChunk)
{
...
void _3dsLoader_old::ReadMaterialGroup(scene::SMesh*pModel, scene::IMeshBuffer *pObject, tChunk *pPreviousChunk)
{
...
void _3dsLoader_old::composeObject(scene::SMesh*mesh,int m)
{
...
const core::string&_3dsLoader_old::getExtension(){
	return g_sJPGExt;
}
/*
//////////////////////////////	Math Functions  ////////////////////////////////*

void _3dsLoader_old::ComputeNormals(t3DModel *pModel)
{
