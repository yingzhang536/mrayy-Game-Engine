...
inline NumberType toNumber(core::UTFString numberString)
{
...
FlashValue::FlashValue(const core::UTFString& stringValue) : strValue(stringValue), numValue(0), boolValue(0), valueType(FT_STRING)
{
}
...
video::SColor FlashValue::getNumberAsColor() const
{
	if(valueType != FT_NUMBER)
...
core::UTFString FlashValue::getString() const
{
